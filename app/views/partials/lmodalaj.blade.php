<div class="modal fade" furl="#" faddurl="#" frmvurl="" id="list_nav_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">List of your selected students</h4></div><div class="modal-body"><ul id="nav_ll_ul_main" class="list-unstyled"> @if($lcount) @foreach ($lists as $list) <li>
                        <div class="media">
