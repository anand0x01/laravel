...
<div class="container">
    <div class="row">
        <div class="col-xs-6  custom_form center-block">
            <form data-pjax method="post" action="{{ URL::route('r.student') }}" class="form-horizontal">
                {{ Form::token() }}
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  {{ Form::email('email', Input::old('email'), array('class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off', 'placeholder' => 'Enter email', 'required' => 'required')) }}
                    ...
                    @endif
                    <span class="help-block"><small class="text-info">Prefer to use your university email adress. Avoid gmail, yahoo, hotmail etc.</small></span>
                  </div>
                </div>
                <div class="form-group">
